    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wishlist', models.ManyToManyField(related_name='wishlist', to='Books.bookmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_perfil', models.ImageField(blank=True, null=True, upload_to=Users.models.info_model.pathImage)),
                ('phone', models.CharField(blank=True, max_length=12, null=True, unique=True, verbose_name='Teléfono')),
